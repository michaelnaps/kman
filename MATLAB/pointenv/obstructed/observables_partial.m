...
%     dPsix = naps.fdm(obs_x, x);
    ...
    dPsix = [
        1, 0, 2*x1, x2, x2, 0, 0, 0, 0, 0, 0, 0, u1, 0, u2, 0, 2*x1-2*r11, 2*x1-2*r12, 2*x1-2*r13, 2*x1-2*r14, 0;
        0, 1, 0, x1, x1, 2*x2, 0, 0, 0, 0, 0, 0, 0, u1, 0, u2, 2*x2-2*r21, 2*x2-2*r22, 2*x2-2*r23, 2*x2-2*r24, 0;
    ];
